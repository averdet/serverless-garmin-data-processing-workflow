# Pattern-based Serverless Data Processing Pipeline using Function-as-a-Service (FaaS) Orchestration Systems - AWS Step Functions

This project contains source code  used for the paper "Pattern-based Serverless Data Processing Pipeline using Function-as-a-Service (FaaS) Orchestration Systems". The serverless application can be deployed with SAM CLI.

The folder includes the following files and folders:

- functions - Code for the application's Lambda functions to check the value of, buy, or sell shares of a stock.
- statemachine - Definition for the state machine that orchestrates the data processing pipeline workflow.
- template.yaml - A template that defines the application's AWS resources.
- data - Data used for the experiments.

This application uses the AWS Step Functions state machine to orchestrate the data processing pipeline. AWS Step Functions lets you coordinate multiple AWS services into serverless workflows so you can build and update apps quickly. Using Step Functions, you can design and run workflows that stitch together services, such as AWS Lambda, AWS Fargate, and Amazon SageMaker, into feature-rich applications.
...
The first command will validate your application, and the second command will build and deploy your application. The next command will package and deploy your application to AWS, with a series of prompts:
...
```bash
health-integration-garmin$ sam build
```
...
```bash
health-integration-garmin$ sam logs -n {Function Name} --stack-name health-integration-garmin --tail
```
...
```bash
aws cloudformation delete-stack --stack-name health-integration-garmin
```
